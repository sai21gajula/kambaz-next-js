  ...
  return (
    <div id="wd-lab1">
      ...
      <div >
        ...
        <strong>GitHub:</strong> <a href="https://github.com/sai21gajula/kambaz-next-js" target="_blank" rel="noopener noreferrer">Kambaz Github</a>
      </div>
        <h3>HTML Examples</h3>
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Please Cut all of your ingredients.</li>
          <li>Mix all ingredients in a bowl.</li>
          <li>Pour mixture into a pan and cook.</li>
        </ol>
